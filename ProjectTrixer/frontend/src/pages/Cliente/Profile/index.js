...
import { FaComments, FaEnvelope, FaBell, FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaLink } from 'react-icons/fa';
        ...
        <div className="profile-perfil">
         <div className="header-profile">
             ...
             <div className="nav-bar-profile">
                 ...
                 <Link to="/newproduct" className="create-new-service">Criar novo Serviço</Link>
